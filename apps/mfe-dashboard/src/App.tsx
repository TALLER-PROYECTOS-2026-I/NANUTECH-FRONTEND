...
import RegistrarNuevoConductorPage from "./modules/registro-conductor";
...
export function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="conductores/dar-de-alta" element={<RegistrarNuevoConductorPage />} />
      ...
      <Route path="/dashboard/admin/conductores/dar-de-alta" element={<RegistrarNuevoConductorPage />} />
