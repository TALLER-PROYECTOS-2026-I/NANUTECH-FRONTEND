// Icono de alerta usado para panico y mensajes criticos.
...
// Icono de llave inglesa para auxilio mecanico.
export function WrenchIcon({ className = 'h-4 w-4' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M14.7 6.3a4 4 0 0 0-5.66 5.66L3 18v3h3l6.04-6.04A4 4 0 0 0 17.7 9.3l-2.4 2.4-3-3 2.4-2.4z" />
    </svg>
  );
}

// Icono de check para casos cerrados o acciones exitosas.
...
// Icono de usuario en las filas de tabla.
export function UserIcon({ className = 'h-3.5 w-3.5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
// Icono de pin GPS para coordenadas y mapas.
export function MapPinIcon({ className = 'h-3.5 w-3.5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
// Icono de telefono para contactar al conductor.
